...
TOKEN = "7140962405:AAH3V2coU8fp1ufGRneh-G3ph5fTqza7ueM"
...
def start(message):
    ...
    bot.send_message(
        ...
        "Интересуетесь ассортиментом телевизоров SAMSUNG в магазине",
        reply_markup=markup,
    )
        ...
        if message.text == "Конечно":
            ...
            for page in range(1, total_pages + 1):
                ...
                for sections in sections:
                    products = sections.find_all("div", class_="tov_prew")
